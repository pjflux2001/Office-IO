...
export default class MyPlayer extends Player {
  ...
  constructor(
    ...
    this.playNameContainerBody = this.playerNameContainer
            ...
            callback: () => {
              ...
              if (item.itemDirection) {
                this.setPosition(
                  ...
                  item.depth + sittingShiftData[item.itemDirection][2]
                );
              ...
              this.play(
                `${this.playerTexture}_sit_${item.itemDirection}`,
                true
              );
